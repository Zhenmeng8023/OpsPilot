...
| 2026-05-09 | V1.0 开发中 / 待提交 | 清理 GitHub Actions 剩余的运行时弃用风险。 | CI 已显式设置 `FORCE_JAVASCRIPT_ACTIONS_TO_NODE24=true`，保持现有 workflow 矩阵不变，并强制 JavaScript actions 脱离已弃用的 Node 20 runtime。 |
