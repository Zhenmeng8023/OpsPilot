...
| Migration pair check | Passed, 15 up/down migration pairs. |
...
- Alert grouping and Incident projection now have baseline API/UI coverage; broader database integration tests are still recommended.
- Agent diagnostics, version inventory, tags/groups, and maintenance windows now have a baseline implementation. Host Group batch disable/diagnostics and group-scoped maintenance windows are wired in.
- Complete responsive/i18n regression for key frontend pages.
