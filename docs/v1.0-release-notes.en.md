...
| Migration pair check | Passed, 14 up/down migration pairs. |
...
- Alert grouping/Incident projection exists; suppression rules and routing policies now have a baseline implementation. Host group matching is wired in; broader database integration tests are still recommended.
