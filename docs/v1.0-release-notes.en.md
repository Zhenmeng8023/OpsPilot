...
- Metrics rollup, retention, and saved dashboards now have a baseline implementation. Rollup/retention now run through background workers; broader database integration tests are still recommended.
