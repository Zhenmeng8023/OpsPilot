    ...
    <main className="page">
      <section className="page-heading">
        <div>
          ...
          <h1>{isNew ? "Create Script" : "Edit Script"}</h1>
        </div>
      </section>
      <form className="panel editor-form" onSubmit={submit}>
        ...
        {!form.content.trim() ? <p className="form-error">Script content cannot be empty.</p> : null}
        ...
        {requestApprovalMutation.isSuccess ? <p className="empty-state">Approval request submitted.</p> : null}
      </form>
    </main>
  );
}
