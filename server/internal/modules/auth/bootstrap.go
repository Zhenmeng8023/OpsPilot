...
var basePermissions = []permissionSeed{
	...
	{"traces:read", "trace", "Read traces", "View trace timelines and lookup results"},
	{"trace.read", "trace", "Read traces", "Legacy trace read permission"},
	{"traces:read_sensitive", "trace", "Read sensitive traces", "View trace payload fields marked as sensitive"},
	{"trace.read_sensitive", "trace", "Read sensitive traces", "Legacy sensitive trace permission"},
	{"ui_smoke:read", "quality", "Read UI smoke evidence", "View UI smoke verification artifacts"},
	{"ui-smoke.read", "quality", "Read UI smoke evidence", "Legacy UI smoke read permission"},
	{"security:review", "security", "Review security evidence", "View permission diffs and secret rotation history"},
	{"security.review", "security", "Review security evidence", "Legacy security review permission"},
